...
public class feedback extends JFrame implements ActionListener{
    ...
    JRadioButton five;
    ButtonGroup rating;
    String[] ages= {"Computer Networks","Java","Software Engineering","DBMS","Microprocessor"};
        
    public feedback(Student s, StudentMain studentMain){
        this.setTitle("Student Feedback Form");
	...
	public void setLocation(int panelx, int i) {
